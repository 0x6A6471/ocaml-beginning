...
let test_e5 () = Alcotest.(check int) "run" 5 E5.run
...
let tests =
  ...
  [ test_case "not" `Quick test_e1
  ; test_case "sum" `Quick test_e2
  ; test_case "power" `Quick test_e3
  ; test_case "run" `Quick test_e5
  ; test_case "lower upper fns" `Quick test_e6
  ]
;;
